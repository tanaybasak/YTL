...
//		$scope.rotateAngle=12;
		...
		function changeTripStatus(){
			...
			var requestURL = 'https://ytlnode-red.mybluemix.net/changeTripStatus/'+$scope.trip_id;
...
//		let count = 0;
		...
		function getDataFromWS(){
			...
			//wsURL = $websocket('ws://localhost:3000','echo-protocol');
			wsURL = $websocket('wss://ytlnode-red.mybluemix.net/ws/data1');
